...
def run_vllm(
    ...
    #     on_trace_ready=torch.profiler.tensorboard_trace_handler('./logs/llama_fp16_rocblas'),
    # ) as prof:
...
def main(args: argparse.Namespace):
    ...
    #                                 args.max_model_len, args.enforce_eager,
    #                                 args.kv_cache_dtype, args.device)
    #         prof.step()  # Add this line to ensure profiler captures the steps
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="../quant_params/llama3-8b/",
